        ...
        >
          <div className='w-full h-[100px] flex justify-center items-center'>
            <div className='w-[65%] flex'>
                <input type="text" placeholder="Search for a course" className="text-[14px] placeholder:text-[#434343]   bg-[#f5f5f5] w-[calc(100%-40px)] pl-4 h-[40px] border-2 border-[#7272F1] border-r-0 rounded-[100px] rounded-r-none p-2" />
