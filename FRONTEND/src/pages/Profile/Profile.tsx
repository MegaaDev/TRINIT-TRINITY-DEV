...
const Profile = ({ bio, name }) => {
    ...
    const renderStars = () => {
        ...
        if (rating % 1 !== 0) {
            stars.push(<img key="half-star" width="20" height="20" src=".//src/assets/halfstar.png" alt="half-star"></img>);
        }
        return stars;
    };
            ...
            <div style={{ width: "60%", height: "auto", padding: "4%" }}>
                ...
                <div className="flex flex-col mt-4 mb-4">
                    ...
                    <div className="mb-1.5 flex gap-2">
                        ...
                        <EmailEditor defaultEmail="pawan324005@gmail.com" onEmailChange={() => {}} />
                    </div>
                </div>
                <div className="flex  mt-4 mb-4 gap-2" >
                    ...
                    <div className="mb-1.5 flex gap-2">
                        <img src=".//src/assets/man.png" width="25" height="25" alt="man" ></img>
                    </div>
                </div>
            </div>
        </>
